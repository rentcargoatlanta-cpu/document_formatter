  ...
  fieldGroups: [
    {
      ...
      fields: [
        ...
        { key: 'original_return_date', label: 'Original return date & time', type: 'datetime' },
        { key: 'extended_return_date', label: 'Extended return date & time', type: 'datetime' },
      ],
    },
    {
      ...
      fields: [
        { key: 'extension_days', label: 'Extension days', type: 'number', computed: true },
        { key: 'extension_daily_rate', label: 'Daily rate', type: 'currency', computed: true },
